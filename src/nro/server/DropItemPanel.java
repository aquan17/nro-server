...
public class DropItemPanel extends JPanel {
    ...
    private void createTableIfMissing() {
        ...
        try (java.sql.Connection conn = getConnection(); java.sql.Statement st = conn.createStatement()) {
            st.executeUpdate(sql);
        } catch (Exception e) {
            e.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this, "Lỗi tạo bảng drop_item: " + e.getMessage());
        }
    }
